        ...
        <div className="md:flex items-center xl:gap-x-20">
          ...
          <div className="md:w-1/2">
            <div className="text-[#6F5D5B] font-dmSans capitalize space-y-3">
              <p className="w-full md:w-[95%] xl:w-[89%]">Satori Ventures investment philosophy is rooted in the conviction that Web3 is the cornerstone of future digital autonomy.</p>

              <p className="w-full md:w-[95%] xl:w-[95%]">providing a foundation for economic decentralization and a crucible for innovations. that transcend today's possibilities, a vision we share and cultivate in partnership with the companies we back.</p>
            </div>
          </div>
        </div>
      </Container>
